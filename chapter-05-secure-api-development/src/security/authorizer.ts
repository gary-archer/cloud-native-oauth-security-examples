...
export interface Authorizer {
    ...
    canViewOrder(orderId: OrderDetails): Promise<AuthorizationResult>;

    canListOrdersForRegionalUsers(): Promise<AuthorizationResult>;

    canListOwnedOrders(): Promise<AuthorizationResult>
}
